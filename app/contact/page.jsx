...
const supportCards = [
  {
    ...
    description: 'Platform questions, feedback, feature requests, or anything that needs the team.',
    ctaHref: 'mailto:rainee@skillbun.tech',
    ctaLabel: 'Email Rainee',
  },
  {
    kind: 'action',
    icon: '🚀',
          ...
          <aside className="contact-side" aria-label="Support details">
            ...
            <div className="social-section glass-panel">
              ...
              <div className="social-links">
                ...
                <a
                  href="https://www.youtube.com/@TeamCosmic-d4e"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="social-badge"
                  aria-label="SkillBun YouTube (opens in a new tab)"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="22"
