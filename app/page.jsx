        ...
        <div className="modal-overlay" style={{ display: 'flex' }}>
          <div className="modal">
            ...
            <div style={{ marginTop: '2rem', textAlign: 'center' }}>
              <button disabled={isLoggingIn} className="btn-form" onClick={handleGoogleLogin} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
            ...
            <p style={{ marginTop: '1.5rem', fontSize: '0.8rem', color: 'var(--muted)', textAlign: 'center' }}>
              By logging in, you agree to our <a href="/terms" style={{ color: 'var(--green)' }}>Terms of Use</a> and <a href="/privacy" style={{ color: 'var(--green)' }}>Privacy Policy</a>. Securely powered by Supabase.
            </p>
          </div>
        </div>
      )}
