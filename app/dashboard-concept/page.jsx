...
import styles from './dashboard-concept.module.css';

export const metadata = {
  title: 'Dashboard Concept - SkillBun',
  description: 'An unlinked SkillBun dashboard concept page for reviewing a redesigned progress workspace.',
};

const navItems = [
  { label: 'Dashboard', href: '/dashboard-concept', icon: 'dashboard', active: true },
  ...
  return (
    <main className={styles.page}>
      ...
      <div className={styles.container}>
        <section className={styles.board} aria-label="Dashboard concept preview">
          <aside className={`${styles.sidebar} ${styles.glassPanel}`} aria-label="Dashboard concept navigation">
            ...
            <div className={styles.sideNav} role="navigation" aria-label="Dashboard concept links">
              {navItems.map((item) => (
                <Link
                  key={item.label}
                  href={item.href}
