  ...
  return (
    <div className="static-page">
      ...
      <ul>
        ...
        <li><strong>AI Capabilities:</strong> The Adaptive Quiz and BunBot chat utilize secure server-side multi-provider AI processing (Groq, OpenRouter, and native engines). While prompt contexts are transmitted securely via encrypted API channels, you are advised not to submit highly sensitive PII in free-text chat fields.</li>
      </ul>
