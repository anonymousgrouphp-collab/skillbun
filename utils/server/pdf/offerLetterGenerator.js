...
export async function generateOfferLetterPdf(employee, options = {}) {
  ...
  const metadataSnapshot = {
    ...
    contract_end_date: employee.contract_end_date ? (employee.contract_end_date.toDate ? employee.contract_end_date.toDate().toISOString() : String(employee.contract_end_date)) : '',
