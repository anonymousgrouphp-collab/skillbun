 ...
 * Features:
 * - 18 High-Conversion, High-Greed, High-Curiosity Variations (6 Categories x 3 Variations)
...
export const RETENTION_TEMPLATES = {
  ...
  reengagement_v1: {
    ...
    name: '🐰 Re-Engagement V1: Candidate Rank & Streak Decaying (Loss Aversion)',
    subject: '⚠️ Your {roadmapTitle} streak & candidate rank is decaying, {name}!',
    description: 'Warns student that their active streak and rank are freezing.',
    isMarketing: true,
  },
  reengagement_v2: {
    id: 'reengagement_v2',
    category: '2. Re-Engagement',
    name: '🐰 Re-Engagement V2: 3-Minute Quick Win to Exam Ticket (Quick Progress)',
    subject: '🔥 3 Minutes to unlock your Free {roadmapTitle} Cert Exam Ticket, {name}!',
    description: 'Pushes candidate for a quick 3-minute node completion.',
    isMarketing: true,
  },
  reengagement_v3: {
    id: 'reengagement_v3',
    category: '2. Re-Engagement',
    name: '🐰 Re-Engagement V3: Recruiter Queue Visibility Alert (Placement Angle)',
    subject: '💡 Recruiter Queue Alert: Complete your {roadmapTitle} track, {name}!',
    description: 'Highlights that active students get indexed for recruiter searches.',
    isMarketing: true,
  },

  // CATEGORY 3: CERTIFICATION EXAM READY NUDGE (60%+ PROGRESS)
  exam_nudge_v1: {
    id: 'exam_nudge_v1',
    category: '3. Cert Ready',
    ...
    description: 'High-status invitation for candidates with 60%+ completion.',
    isMarketing: true,
  },
  exam_nudge_v2: {
    id: 'exam_nudge_v2',
    ...
    description: 'Framed as a waived ₹15,000 professional exam fee.',
    isMarketing: true,
  },
  exam_nudge_v3: {
    id: 'exam_nudge_v3',
    ...
    description: 'Pushes student to mint their QR verifiable certificate link.',
    isMarketing: true,
  },
  ...
  exam_failed_v1: {
    id: 'exam_failed_v1',
    category: '4. Cooldown',
    name: '📚 Cooldown V1: 100% Free Unlimited Retake Granted (Zero Risk)',
    subject: '⚡ Retake Ticket Granted! 100% Free Retake for {roadmapTitle}, {name}',
    description: 'Reminds student that retakes are 100% free with zero penalty.',
    isMarketing: true,
  },
  exam_failed_v2: {
    id: 'exam_failed_v2',
    category: '4. Cooldown',
    name: '📚 Cooldown V2: Review SBV1 Encrypted Study Vault (Pass Guarantee)',
    subject: '📖 Cheat-Sheet Unlocked: Review SBV1 Guides to Guarantee 100% Pass',
    description: 'Directs candidate to SBV1 encrypted guides for missing topics.',
    isMarketing: true,
  },
  exam_failed_v3: {
    id: 'exam_failed_v3',
    category: '4. Cooldown',
    name: '📚 Cooldown V3: Missed Passing by Just 2 Questions (High Confidence)',
    subject: '💪 You missed passing by just 2 questions, {name}! 1-Hour Cooldown Ready',
    description: 'High-confidence encouragement to retake immediately after cooldown.',
    isMarketing: true,
  },
          ...
          <tr>
            <td class="email-header" style="background-color: #0d1117; padding: 24px 32px; border-bottom: 2px solid #00e599; text-align: center;">
              ...
              <div style="color: #8b949e; font-size: 11px; margin-top: 4px; font-weight: 700; text-transform: uppercase; letter-spacing: 1.2px;">
                SkillBun.tech • Hop Into The Right Tech Career • 100% Free
              </div>
            </td>
          </tr>
